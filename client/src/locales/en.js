export default {
  ...
  restocking: {
    ...
    recommendationsSubtitle: 'Increasing demand items first, then stable. Decreasing items excluded.',
  ...
  orders: {
    ...
    restockingOrdersDescription: 'Internally generated restocking orders — 14-day delivery lead time',
