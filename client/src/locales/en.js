export default {
  ...
  orders: {
    ...
    submitted: {
      ...
      empty:
        "No restocking orders submitted yet. Build one in the Restocking tab.",
      orderNumber: "Order Number",
  ...
  restocking: {
    title: "Restocking",
    description:
      "Set a budget and let the demand forecast recommend what to restock",
    ...
    noRecommendations:
      "No restock needed — every forecast item is fully stocked.",
