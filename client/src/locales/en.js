export default {
  ...
  restocking: {
    title: "Restocking",
    description:
      "Plan a budget-constrained restock against the latest demand forecast.",
    budget: "Budget",
    ...
    overBudget: "Over budget — reduce quantities to submit.",
    setQuantity: "Set at least one quantity above zero.",
    orderSubmitted: "Order {orderNumber} submitted successfully.",
    orderSubmittedFailed: "Failed to submit order: {error}",
    table: {
      sku: "SKU",
      name: "Name",
      forecastedDemand: "Forecasted Demand",
  ...
  reports: {
    ...
    noQuarterlyData: "No quarterly data available",
