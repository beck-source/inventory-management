export default {
  ...
  orders: {
    ...
    quantity: "Qty",
    submittedTitle: "Submitted Restocking Orders",
    submittedItems: "{count} item(s)",
    submittedLeadDays: "{days} days",
    submittedTable: {
      id: "Order ID",
      warehouse: "Warehouse",
      items: "Items",
  ...
  restocking: {
    title: "Restocking",
    description:
      "Set a budget and submit a restocking order based on demand and stock level.",
    budget: "Budget",
    ...
    noRecommendations:
      "No items can be recommended within this budget. Try increasing the budget.",
    cartTooLarge:
      "Cart total exceeds the budget — adjust quantities or budget.",
    warehouseEta: "ETA in {days} days",
    urgency: {
      urgent: "Urgent",
