export default {
  ...
  restocking: {
    title: '補充計画',
    description: '需要予測と予算に基づいて補充品目を自動推奨',
    budgetLabel: '利用可能な予算',
    recommendedItems: '推奨品目',
    totalCost: '合計コスト',
    remainingBudget: '残予算',
    placeOrder: '注文を確定',
    orderPlaced: '補充注文が送信されました',
    noRecommendations: '現在の予算内で推奨できる品目はありません',
    confirmOrder: 'この補充注文を確認して送信しますか？',
    submitting: '送信中...',
    belowReorder: '再注文点以下',
    table: {
      sku: 'SKU',
  ...
  reports: {
    ...
    change: '変化',
    growthRate: '成長率',
    totalRevenueYTD: '年初来総売上高',
    avgMonthlyRevenue: '月次平均売上高',
