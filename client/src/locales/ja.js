export default {
  ...
  restocking: {
    title: "補充",
    description: "最新の需要予測に基づき、予算内で補充計画を立てます。",
    budget: "予算",
    budgetSet: "設定予算",
    totalCost: "総コスト",
    remaining: "残額",
    ...
    placeOrder: "発注する",
    submitting: "送信中...",
    overBudget: "予算超過 — 数量を減らして送信してください。",
    setQuantity: "少なくとも1つの数量を0より大きく設定してください。",
    orderSubmitted: "注文 {orderNumber} が正常に送信されました。",
    orderSubmittedFailed: "注文の送信に失敗しました: {error}",
    table: {
      sku: "SKU",
      name: "名前",
      forecastedDemand: "予測需要",
  ...
  reports: {
    title: "パフォーマンスレポート",
    description: "四半期業績指標と月次トレンドを表示します",
