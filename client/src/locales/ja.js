export default {
  ...
  restocking: {
    title: '補充',
    description: '予算を設定し、最大の需要不足を補充します',
    budgetLabel: '利用可能な予算',
    budgetHint: '不足量の大きい順に予算が尽きるまで推奨されます',
    coverage: '{total}件中{covered}件をカバー',
    plannedSpend: '予定支出',
    remaining: '残り',
    recommendations: '推奨補充',
    overBudget: '予算超過',
    inBudget: '対象',
    noShortages: '現在予測された不足はありません',
    placeOrder: '補充注文を送信',
    submitting: '送信中...',
    submitted: '注文 {orderNumber} を送信しました — {count}件、{total}',
