export default {
  ...
  orders: {
    ...
    itemsCount: "{count}件",
    quantity: "数量",
    submittedTitle: "送信済み補充注文",
    submittedItems: "{count}品目",
    submittedLeadDays: "{days}日",
    submittedTable: {
      id: "注文ID",
      warehouse: "倉庫",
      items: "品目",
  ...
  restocking: {
    title: "在庫補充",
    description:
      "予算を設定し、需要と在庫レベルに基づいて補充注文を送信します。",
    budget: "予算",
    budgetLabel: "利用可能予算",
    cartTotal: "カート合計",
    remaining: "残り予算",
    ...
    placing: "注文送信中...",
    noRecommendations:
      "この予算内で推奨できる品目はありません。予算を増やしてください。",
    cartTooLarge:
      "カート合計が予算を超えています — 数量または予算を調整してください。",
    warehouseEta: "{days}日後到着予定",
    urgency: {
      urgent: "緊急",
      rising: "需要増加",
      stable: "安定",
