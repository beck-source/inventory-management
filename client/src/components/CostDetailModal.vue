...
.summary-card.total {
  background: linear-gradient(135deg, var(--uui-primary) 0%, var(--uui-primary-hover) 100%);
  color: white;
}
...
.cost-item.procurement {
  border-color: var(--uui-primary-subtle);
  background: var(--uui-primary-subtle);
}

.cost-item.operational {
  border-color: var(--uui-accent-subtle);
  background: var(--uui-accent-subtle);
}

.cost-item.labor {
  border-color: var(--uui-success-subtle);
  background: var(--uui-success-subtle);
}

.cost-item.overhead {
  border-color: var(--uui-warning-subtle);
