...
.legend-dot.procurement { background: var(--uui-primary); }
.legend-dot.operational { background: var(--uui-accent); }
.legend-dot.labor { background: var(--uui-success); }
.legend-dot.overhead { background: var(--uui-warning); }
.legend-dot.revenue-color { background: var(--uui-text-primary); }
.legend-dot.cost-color { background: var(--uui-error); }
...
.revenue-card {
  border-left: 4px solid var(--uui-text-primary);
}

.cost-card {
  border-left: 4px solid var(--uui-error);
}
...
.revenue-bar {
  background: var(--uui-text-primary);
}
...
.bar-segment.procurement { background: var(--uui-primary); }
.bar-segment.operational { background: var(--uui-accent); }
.bar-segment.labor { background: var(--uui-success); }
.bar-segment.overhead { background: var(--uui-warning); }
...
.category-bar {
  height: 100%;
  background: linear-gradient(90deg, var(--uui-primary) 0%, var(--uui-primary-hover) 100%);
  border-radius: 4px;
...
.transactions-table td {
  ...
  border-bottom: 1px solid var(--uui-surface-sunken);
  font-size: 0.875rem;
}
