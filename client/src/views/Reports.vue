...
export default {
  ...
  setup() {
    ...
    const calculateSummaryStats = () => {
      ...
      totalRevenue.value = monthlyData.value.reduce((sum, month) => sum + month.revenue, 0)
      ...
      totalOrders.value = monthlyData.value.reduce((sum, month) => sum + month.order_count, 0)
