    ...
    <div v-else>
      ...
      <div class="card">
        ...
        <div class="table-container">
          <table class="reports-table">
            ...
            <tbody>
              <!-- Use q.quarter as stable key instead of index -->
      ...
      <div class="card">
        ...
        <div class="chart-container">
          <div class="bar-chart">
            <!-- Use month.month as stable key instead of index -->
      ...
      <div class="card">
        ...
        <div class="table-container">
          <table class="reports-table">
            ...
            <tbody>
              <!-- Use month.month as stable key; still track index via (month, index) for prev-month lookup -->
...
export default {
  ...
  setup() {
    ...
    // Currency symbol derived from current locale (mirrors Orders.vue pattern)
    ...
    // Use shared filters so this view reacts to the global filter bar
    const {
      selectedPeriod,
      selectedLocation,
      selectedCategory,
    ...
    const loadData = async () => {
      try {
        ...
        // Use centralized api client instead of raw axios
    ...
    // Currency formatting: 2 decimals, locale-grouped
    ...
    // Parse YYYY-MM month string into a localized "Mon YYYY" label
    const formatMonth = (monthStr) => {
      // Build via local-time constructor so the month doesn't drift by a day in UTC-offset zones
    ...
    // Bar height scaled so the tallest bar = 200px
    ...
    const getChangeValue = (current, previous) => {
      ...
      if (change > 0) {
        return '+' + currencySymbol.value + formatCurrency(change)
      } else if (change < 0) {
        return '-' + currencySymbol.value + formatCurrency(Math.abs(change))
      }
